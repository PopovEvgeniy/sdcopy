...
This software is a text interface/console program. Lets look to command line argument.
...
Program source compatibility with any moder C compiler.
Open sdc.c file and check platform identifer before start compiling.
